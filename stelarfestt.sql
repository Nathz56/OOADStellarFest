...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2024 at 06:10 PM
...
--
ALTER TABLE `vendor`
  ADD CONSTRAINT `vendor_ibfk_1` FOREIGN KEY (`vendorId`) REFERENCES `users` (`id`);
COMMIT;
